!function(t, e, n, o) {
    if (!n)
        throw ReferenceError("Dependence jQuery not found.");
    var i = t
      , s = "FlipBookPlugins"
      , a = {}
      , r = function(t) {
    ...
    var d = function() {
      ...
      , c = function(t) {
        function e(e) {
            t.call(this),
            this.options = e,
            this.__guid__ = r("component"),
            this.loadList = [],
            this.visible = !0,
            this.audioAutoPlay = !1,
            this.node = n("<div>").appendTo(e.container).css(e.style),
            this.addLoadItem("audio", this.createAudio);
        ...
        e.prototype.start = function() {
            ...
            if (t && t.src) {
                var e = this.audio;
                this.audioAutoPlay && this.visible && (this.audioAutoPlay = !1,
                e.play())
            }
        }
        ,
            ...
            n.each(e, function(n, o) {
                o.cb.apply(t, [function() {
                    if (!t.destroyed) {
                        var n = e.indexOf(o);
                        n >= 0 && (e.splice(n, 1),
                        0 === e.length && (t.onloadTimeout = setTimeout(function() {
                            t.onload()
                        }, 1e3)))
                    }
                }
        ...
        e.prototype.createAudio = function(t) {
            ...
            if (e && e.src) {
                var o = new Audio;
                o.volume = e.volume || 1,
                n.data(o, "volume", o.volume),
                n(o).one("canplay error", function() {
                    t()
        ...
        e.prototype.show = function() {
            ...
            this.node.show(),
            this.audioAutoPlay && this.audio && this.audio.play(),
            this._show())
        }
        ,
        ...
        e.prototype.destroy = function() {
            this.onloadTimeout && clearTimeout(this.onloadTimeout),
            this.onDestroy(),
            this.destroyed = !0,
            this.node.remove()
        }
    ...
    c.addMenuIcon("Audio", function(t) {
        ...
        if (i && i.src) {
            ...
            o.on("click", function() {
                var t = e.audio
                  , i = o.data("paused");
                t.ended && (t.currentTime = 0),
                r && r.stop(!1, !1),
                i ? (t.currentTime ? r = n.audioFadeIn(t) : (t.volume = 1,
                t.play()),
                o.data("paused", !1).addClass(a).removeClass(s)) : (r = n.audioFadeOut(t),
                o.data("paused", !0).addClass(s).removeClass(a))
            })
        } else
            o.remove()
    });
    var u = function(o) {
        function i(e) {
            ...
            n(e.container)), f = 0; i = u[f++]; )
                i = this.transform(i),
                p = n("<div>").addClass(s).appendTo(h),
                p.css(i.position),
                p.css("zIndex", e.zIndex),
                i.container = p,
                a = l.get(i.type),
                r = new a(i),
                d = this.createComponentMenu(a.menulist, r),
                c = n("<div>").addClass("loading").html("<div><span></span><span></span><span></span><span></span></div>"),
                p.append(d),
                p.append(c),
                this.loadComponent(p, r, c);
            this.dragable(h),
            n(t).resize(this.resizeHandler = this.resize.bind(this)),
            this.stopPropagationHandler = function(t) {
                t.preventDefault()
            }
            ,
            h.on("mousedown dbclick", "img", this.stopPropagationHandler),
            h.on("mousedown dbclick", ".menu", this.stopPropagationHandler)
        }
        return p(i, o),
        ...
        i.prototype.dragable = function(t) {
            var o, i, a, r, d, p, l, c, u, h = n(n("#bookContainer")[0] || e), f = 0, v = 0, m = 5, y = n("<div>").addClass("dragCover"), g = !1;
            t.on("touchstart mousedown", ".dragable", this.dragDownHandler = function(t) {
                c = !0;
                var e = t.originalEvent.changeTouches;
                f = e ? e[0].clientX : t.pageX,
                v = e ? e[0].clientY : t.pageY,
                p = n(t.currentTarget),
                t.preventDefault()
            }
            ),
            h.on("touchmove mousemove", this.dragMoveHandler = function(e) {
                if (c) {
                    ...
                    u = p.data("dragable"),
                    l = n(p.parents("." + s)[0] || p),
                    u && u.start ? u.start(f, v) : (o = l[0].offsetLeft,
                    i = l[0].offsetTop,
                    a = t.width(),
                    r = t.height()),
                    u && u.cover === !1 || y.appendTo(l)),
                    u && u.move ? u.move(C, k) : l.css({
                        left: (o + C) / a * 100 + "%",
                        top: (i + k) / r * 100 + "%"
                    }))
                }
        ...
        i.prototype.undragable = function() {
            ...
            n(t).off("mousedown dbclick", this.stopPropagationHandler).off("mousedown touchstart", this.dragDownHandler),
            o.off("mousemove touchmove", this.dragMoveHandler),
            o.off("mouseup touchend touchcancel", this.dragEndHandler),
            this.stopPropagationHandler = null,
        ...
        i.prototype.show = function() {
            for (var t, e = 0, n = this.components; t = n[e++]; )
                t.show()
        }
        ,
        ...
        i.prototype.destroy = function() {
            for (var e, o = 0, i = this.components; e = i[o++]; )
                e.destroy();
            this.components = null,
            this.undragable(),
            n(t).off("resize", this.resizeHandler),
    ...
    var h = function(t) {
        function o(e) {
            t.call(this),
            this.options = e,
            this.node = n("<div>").addClass("fbvp").css({
                width: e.width,
                height: e.height,
                left: e.left,
                top: e.top
        ...
        o.prototype.init = function() {
            var t = this
              ...
              , p = n(d).click(function() {
                d.duration && (d.paused ? (a.removeClass("stop").addClass("play"),
                d.play()) : (a.removeClass("play").addClass("stop"),
                d.pause()),
                a.stop(!0, !0).css({
                    opacity: 1,
                    transform: "none"
            ...
            var f, v = i("volume-controls"), m = i("volume-button").addClass("unmuted").click(function() {
                d.muted = !d.muted
            ...
            s("fg").appendTo(y)), _ = s("cursor").appendTo(y);
            v.append(m).append(y).appendTo(r);
            var w, C, k = i("time").appendTo(r), b = n("<span>").addClass("current").appendTo(k).text("00:00"), T = (n("<span>").addClass("separator").appendTo(k).text(" / "),
            n("<span>").addClass("total").appendTo(k).text("00:00")), x = (i("fullscreen").appendTo(r).click(function() {
            ...
            null), I = i("progress-container").mousedown(function(t) {
                var e = d.duration;
                if (e) {
                    null === x && (x = d.paused),
                    d.pause();
            ...
            }), E = (i("progress-padding").appendTo(I),
            i("progress-bar").appendTo(I)), z = (s("bg").appendTo(E),
            s("fg").appendTo(E)), H = s("cursor").appendTo(E);
            o.append(l).append(c).append(a).append(I).append(r),
            ...
            p.on("volumechange", function() {
                ...
                g.css("width", e),
                _.css("left", e),
                0 === t ? m.removeClass("unmuted").addClass("muted") : m.removeClass("muted").addClass("unmuted")
            });
            var S = function(t) {
                var e = ~~(t / 3600)
                  , n = ~~(t % 3600 / 60)
        ...
        ,
        o.prototype.createElementByPrefix = function(t) {
            return t = t ? t + "__" : "",
            function(o) {
      ...
      , f = function(t) {
        ...
        e.prototype.init = function() {
            ...
            if (t.match(/facebook/gi))
                ...
                this.node.find(".embed__wrap").append(e),
                this.iframe = e
            }
        }
        ,
        e.prototype.parseCode = function(t) {
            for (var e, o = n("<div>").html(t)[0], i = o.childNodes, s = 0, a = 0; e = i[s++]; )
                if ("SCRIPT" === e.nodeName && e.src) {
                    a++;
                    var r = e.onload;
                    r = r ? "(" + r.toString() + ").apply(this,arguments);" : "",
                    e.setAttribute("onload", "leo_loadCallback();" + r)
                }
            ...
            return d += o.innerHTML,
            o.innerHTML = "",
            o = null,
            d.replace(/'/g, "\\'").replace(/%22/g, "").replace(/%27/g, "")
        }
        ,
        e.prototype.destroy = function() {
    ...
    var v = function(t) {
        function e(e) {
            t.call(this, e),
            this.node.addClass("img dragable"),
            this.addLoadItem("img", this.loadImage)
        }
        return p(e, t),
    ...
    var m = function(t) {
        function e(e) {
            t.call(this, e),
            this.paused = !1,
            this.node.addClass("linklist"),
            this.init()
        }
        return p(e, t),
        e.prototype.init = function() {
            for (var t, e, o, i, s = this.options, a = s.title, r = s.body, d = this.node, p = n("<input>").addClass("linklist__title dragable").val(a.content).attr("disabled", !0).css(a).appendTo(d), l = d.height(), c = p[0].offsetHeight, u = l - c - 2, h = n("<ul>").appendTo(n("<div>").addClass("linklist__body").appendTo(d).css("height", u)), f = r.content, v = 0; t = f[v++]; )
                e = n("<li>"),
                i = t.title || t.content,
                o = n("<span>").html(i),
                t.link ? (o.attr("title", t.link),
                e.append(n("<a>").attr({
                    href: t.link,
                    target: "_blank"
                }).append(o).css(r))) : e.append(o.css(r)),
                h.append(e)
        }
        ,
        e.prototype.start = function() {
        ...
        e.prototype.resize = function() {
            var t = this.node
              ...
              , o = e - n - 2;
            t.find(".linklist__body").css("height", o),
            this.checkScroll()
        }
        ,
        e.prototype.bindDragEvent = function() {
            var t, e = this, o = this.node.find(".linklist__body"), i = o.find("ul");
            o.addClass("dragable").data("dragable", {
                start: function() {
                    i.stop(),
                    t = parseFloat(i.css("top"))
                },
                move: function(e, n) {
                    i.css("top", t + n)
                },
        ...
        e.prototype.checkScroll = function() {
            var t = this;
            this.scrollingAnimation && (this.scrollingAnimation.stop(),
            this.scrollingAnimation = null);
            var e, o = this.node, i = o.find(".linklist__body"), s = i.find("ul"), a = s.height(), r = 40, d = i.height(), p = n.now, l = !1;
        ...
        e.prototype.enter = function() {
            ...
            n.slideUp(0, function() {
                t.node.css("opacity", t.options.opacity || 1),
                e.animate({
                    width: "100%",
                    opacity: 1
                }, 300, function() {
        ...
        e.prototype.destroy = function() {
            t.prototype.destroy.call(this),
            this.scrollingAnimation && (this.scrollingAnimation.stop(!0, !1),
            this.scrollingAnimation = null)
        }
        ,
        e
    }(c);
    l.register("linklist", m),
    m.addMenuIcon("Scroll", function(t) {
        var e = this
          , o = "menu__scroll--stop"
          , i = "menu__scroll--play"
          , s = n(t);
        s.addClass(o).click(function() {
            e.paused = !e.paused,
            e.paused ? s.removeClass(o).addClass(i) : s.removeClass(i).addClass(o)
        })
    });
    var y = function(e) {
        function o(t) {
            ...
            this.count = 0,
            this.__paused = null,
            this.node.addClass("newsticker dragable"),
            this.options.pauseOnMouseover = !0,
            this.init()
        }
        return p(o, e),
        o.prototype.transition = function(t, e, n, o) {}
        ,
        ...
        o.prototype.init = function() {
            ...
            if (o.controls) {
                ...
                "newsticker__controls--play")
                  ...
                  , h = n("<i>").addClass(o.autoplay ? u : c).appendTo(l).click(function() {
                    t.paused ? (t.play(),
                    h.addClass(u).removeClass(c)) : (t.pause(),
                    h.addClass(c).removeClass(u))
                });
            ...
            this.transition = this.getTransition(this.options.effect),
            this.transitionContainer = d
        }
        ,
        ...
        o.prototype.update = function(t, e) {
            !e && !this.paused && 300 > t ? (this.count += t) >= this.interval && (this.next(),
        ...
        o.prototype.skip = function(t) {
            ...
            if (n !== t) {
                ...
                t > i - 1 && (t = 0,
                o = !1),
                null === this.__paused && (this.__paused = this.paused),
                this.paused = !0;
                var s = function() {
                    e.paused = e.__paused,
                    e.__paused = null
        ...
        o.prototype.fade = function(t, e, n, o) {
            var i = this.duration;
            this.prevTarget && this.prevTarget.remove(),
            e && e.stop().fadeOut(i, function() {
                this.remove()
            }),
    ...
    var g = function(t) {
        function e(e) {
            t.call(this, e),
            this.startLeft = 0,
            this.node.addClass("newsbar")
        }
        return p(e, t),
        e.prototype.transition = function(t, e, n, o) {
            e && e.remove(),
            n.css("left", this.bodywidth),
            this.currentWidth = n.width(),
            o()
        }
        ,
    ...
    var _ = function(t) {
        function e(e) {
            ...
            this.paused = !0,
            this.count = 0,
            this.node.addClass("slide dragable"),
        ...
        e.prototype.init = function() {
            for (var t, e, i, s = this, a = this.node, r = this.options, d = r.slides, p = n("<ul>").addClass("slide--pages").appendTo(a), l = n("<div>").addClass("slide--title").appendTo(a), c = n("<ul>").addClass("slide--thumbnails").appendTo(a), u = this.width, h = this.height, f = function(t, e) {
                ...
                0 === m && l.html(i.title),
                e = n("<img>"),
                this.addLoadItem("img" + m, function(t, e, n) {
                    return function(o) {
                ...
                t = n("<li>").appendTo(p).width(u).height(h),
                i.link ? n("<a>").attr({
                    href: i.link,
                    target: "_blank",
                    title: i.link
                }).append(e).appendTo(t) : t.append(e),
                n("<li>").appendTo(c).on("click", v(m)),
                m++
        }
        ,
        e.prototype.start = function() {
        ...
        e.prototype.resize = function() {
            ...
            this.width = this.node.width(),
            this.height = this.node.height(),
            this.node.find("slide--pagewrap").find("img").each(function(e, n) {
                t.setImageSize(n, e)
            }),
        ...
        e.prototype.autoskip = function() {
            ...
            this.animation = n({
                ...
                step: function() {
                    var n = o()
                      , s = n - t;
                    !i && !e.paused && 300 > s ? (e.count += s,
                    e.count >= e.interval && e.skip(e.currentIndex + 1)) : e.count = 0,
                    t = n
                }
            });
            var s = function(t) {
        ...
        e.prototype.skip = function(t) {
            ...
            t > e.length - 1 && (t = 0);
            var n = e[t]
              , o = (this.node.find(".slide--pages").css("transform", "translateX(" + this.width * -t + "px)"),
            this.node.find(".slide--title"))
              , i = n.title || n.content || "";
            n.link && i && o.html("<a href='" + n.link + "' title='" + i + "' target='_blank'>" + i + "</a>");
            var s = this.node.find(".slide--thumbnails")
              , a = "active";
            s.find("." + a).removeClass(a),
            s.find("li").eq(t).addClass(a),
            this.currentIndex = t
        }
        ,
    ...
    l.register("slide", _),
    _.addMenuIcon("Autoskip", function(t) {
        var e = this
          , o = n(t)
          , i = "menu__autoskip--stop"
          , s = "menu__autoskip--play";
        o.addClass(this.options.autoplay ? i : s),
        o.click(function() {
            e.paused = !e.paused,
            e.paused ? o.addClass(s).removeClass(i) : o.addClass(i).removeClass(s)
        })
    }),
    ...
    var C = function(e) {
        function o(t) {
            e.call(this, t);
            for (var n, o, i = this.node.addClass("ticker"), s = this.options.rss, a = 0; n = s[a++]; )
                o = this.creatItem(n),
                i.append(o)
        }
        return p(o, e),
        o.prototype.creatItem = function(e) {
            var o = n('<div class="ticker__item"><img class="item__img"src="' + e.src + '""><div class="item__text"><p class="text__title">' + e.title + '</p><p class="text__content">' + e.content + '</p></div><div class="clear"></div></div>')
              , i = this.options;
            return o.find(".text__title").css(i.title),
            o.find(".text__content").css(i.content),
            o.css("backgroundColor", i.style.backgroundColor).hover(function() {
